...
public class PythonEditor_SD extends TestBase{
	...
	public void the_user_is_on_the_time_complexity_page() throws IOException, InterruptedException {
	  ...
	  public void the_user_clicks_the_practise_questionlink() throws IOException { 
		  practicePage = timecomplexitypage.practiceLinkclick(); 
		  
	  }
	  
	  @Then("The user doesn't find any practice problems and page is blank") 
	  public void the_user_doesn_t_find_any_practice_problems_and_page_is_blank() throws IOException { 
