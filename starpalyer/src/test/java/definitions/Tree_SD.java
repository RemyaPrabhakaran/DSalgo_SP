...
public void the_user_should_be_directed_to_implementation_of_bts_page() {
  ...
  @Given("The user is in the Overview of Treestry Editor Page") public void
  the_user_is_in_the_overview_of_trees_try_editor_page() throws IOException,
  InterruptedException {
  ...
  new Datastructure_Page(); treePage= new TreePage_Page();
  treePage.verifySignedinUser(); treehomepage_page
  =datastructurePage.treeGetStartBtn(); treehomepage_page = new
  TreeHomePage_Page(); String treeintro =
  treehomepage_page.verifyTreeIntropage(); Assert.assertEquals(treeintro,
  "Tree"); treehomepage_page = new TreeHomePage_Page();
  treehomepage_page.clickoverviewofTrees();
  treehomepage_page.verifyoverviewofTrees();
  ...
  public void the_user_writes_valid_python_code_and_clicks_run_button_in_tree()
  ...
  public void
  user_is_able_to_see_the_output_in_console_in_tree_try_editor_page() { 
  tryherePage.verifyConsoleOutput(); }
  
  @Given("The user is in the Terminologiestry Editor Page") public void
  the_user_is_in_the_terminologies_try_editor_page() throws IOException,
  InterruptedException {
  ...
  treePage.verifySignedinUser();
  treehomepage_page
  =datastructurePage.treeGetStartBtn(); 
 String treeintro =treehomepage_page.verifyTreeIntropage(); 
 Assert.assertEquals(treeintro,
  "Tree"); 
  treehomepage_page.clickTerminologies();
  treehomepage_page.verifyterminologies();
  timecomplexitypage_page = new TimecomplexityPage_Page();
  timecomplexitypage_page.clickTryHere();
	  ...
	  public void the_user_is_in_the_types_of_trees_try_editor_page() throws IOException,
	  InterruptedException 
  ...
  @Given("The user is in the Binary Search Treestry Editor Page") public void
  the_user_is_in_the_binary_search_trees_try_editor_page() throws IOException, InterruptedException {
	  initialization(); homepage = new HomePage_Page(); 
	  introPage =  homepage.clickGetStartButton(); 
	  introPage = new IntroductionPage_Page();
			  signinPage=introPage.clickSignin(); 
